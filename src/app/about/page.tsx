...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "shamavachar20@gmail.com",
    href: "mailto:shamavachar20@gmail.com",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">SHAM AVACHAR</p>
        ...
        <main className="basis-3/4 w-[500px]">
          ...
          >
            ...
            <p className="mb-10 text-roboto">
              Hey there! I&apos;m Sham, a Fullstack developer passionate about
